...
export default function Hero(){
  return(
    <section id="hero">
      <div className="container flex flex-col-reverse md:flex-row px-6 mx-auto mt-10 space-y-0 md:space-y-0">
        ...
        <div className="md:w-1/2">
          <Image src={DATA.heroIllustration} width={500} height={500} alt="illustration-intro" />
        </div>
      </div>
    </section>
  )
